...
def loginSC():
	...
	if username =="begejes" and password =="pitu":
		print"\033[1;96m[✓] \033[1;92mLogin success"
		time.sleep(1)
		login()
	else:
		print"\033[1;96m[!] \033[1;91mSalah Cok!!"
		time.sleep(1)
                LoginSC()
